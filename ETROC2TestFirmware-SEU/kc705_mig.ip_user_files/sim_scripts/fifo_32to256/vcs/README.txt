...
#
# Generated by export_simulation on Thu Jul 09 20:42:40 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './fifo_32to256.sh' script.

./fifo_32to256.sh -reset_run
...
./fifo_32to256.sh -noclean_files

For more information on the script, please type './fifo_32to256.sh -help'.

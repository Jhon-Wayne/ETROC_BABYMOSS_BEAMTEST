...
#
# Generated by export_simulation on Sat Jan 23 16:00:43 -0600 2021
#
################################################################################
...
'-reset_run' switch to the './fifo32to32.sh' script.

./fifo32to32.sh -reset_run
...
./fifo32to32.sh -noclean_files

For more information on the script, please type './fifo32to32.sh -help'.
